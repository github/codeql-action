...
- Once [private package registries](https://docs.github.com/en/code-security/how-tos/secure-at-scale/configure-organization-security/manage-usage-and-access/giving-org-access-private-registries) can be configured for organisations with OIDC-based authentication, the CodeQL Action will now be able to accept such configurations. [#3562](https://github.com/github/codeql-action/pull/3562)
