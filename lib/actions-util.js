...
const deepenGitHistory = async function () {
    try {
        await runGitCommand((0, exports.getOptionalInput)("checkout_path"), ["fetch", "origin", "HEAD", "--no-tags", "--deepen=1"], "Cannot deepen the shallow repository.");
    }
    catch {
...
const gitRepack = async function () {
    try {
        await runGitCommand((0, exports.getOptionalInput)("checkout_path"), ["repack", "-d"], "Cannot repack the repository.");
    }
    catch {
        // Errors are already logged by runGitCommand()
    }
