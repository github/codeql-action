...
exports.isValidUploadInput = exports.printDebugLogs = exports.isAnalyzingDefaultBranch = exports.getRelativeScriptPath = exports.isRunningLocalAction = exports.workflowEventName = exports.sendStatusReport = exports.createStatusReportBase = exports.getActionVersion = exports.getActionsStatus = exports.getRef = exports.computeAutomationID = exports.getAutomationID = exports.getAnalysisKey = exports.determineMergeBaseCommitOid = exports.getCommitOid = exports.getTemporaryDirectory = exports.getOptionalInput = exports.getRequiredInput = void 0;
...
async function isValidUploadInput(input) {
    if (input === undefined)
        return true;
    return ["always", "failure-only", "never", "true", "false"].includes(input);
}
exports.isValidUploadInput = isValidUploadInput;
