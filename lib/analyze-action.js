...
async function sendStatusReport(startedAt, config, stats, error, trapCacheUploadTime, dbCreationTimings, didUploadTrapCaches, trapCacheCleanup, logger) {
    const isThirdPartyAnalysis = !(0, status_report_1.isFirstPartyAnalysis)(status_report_1.ActionName.Analyze);
    const status = (0, status_report_1.getActionsStatus)(isThirdPartyAnalysis, error, stats?.analyze_failure_language);
