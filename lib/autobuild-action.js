...
async function sendCompletedStatusReport(config, logger, startedAt, allLanguages, failingLanguage, cause) {
    ...
    const isThirdPartyAnalysis = !(0, status_report_1.isFirstPartyAnalysis)(status_report_1.ActionName.Autobuild);
    const status = (0, status_report_1.getActionsStatus)(isThirdPartyAnalysis, cause, failingLanguage);
