...
exports.processCliConfigurationError = exports.cliToActionErrorsConfig = exports.isCliConfigurationError = exports.cliErrorsConfig = exports.CliError = void 0;
 ...
 */
exports.cliToActionErrorsConfig = {
    [CliError.InitCalledTwice]: {
...
function processCliConfigurationError(cliError, cliErrorMessage) {
    const cliToActionErrorConfig = exports.cliToActionErrorsConfig[cliError];
