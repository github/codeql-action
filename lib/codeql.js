        ...
        async databaseInitCluster(config, sourceRoot, processName, qlconfigFile, logger) {
            ...
            try {
                ...
                if (e instanceof CommandInvocationError) {
                    if ((0, cli_config_errors_1.isCliConfigurationError)(cli_config_errors_1.CliError.InitCalledTwice, e.message)) {
                        throw new util.ConfigurationError((0, cli_config_errors_1.processCliConfigurationError)(cli_config_errors_1.CliError.InitCalledTwice, e.message));
                    }
                    if ((0, cli_config_errors_1.isCliConfigurationError)(cli_config_errors_1.CliError.IncompatibleWithActionVersion, e.message)) {
                        throw new util.ConfigurationError((0, cli_config_errors_1.processCliConfigurationError)(cli_config_errors_1.CliError.IncompatibleWithActionVersion, e.message));
                    }
                    if ((0, cli_config_errors_1.isCliConfigurationError)(cli_config_errors_1.CliError.InvalidSourceRoot, e.message)) {
                        throw new util.ConfigurationError((0, cli_config_errors_1.processCliConfigurationError)(cli_config_errors_1.CliError.InvalidSourceRoot, e.message));
                    }
                }
                throw e;
            }
        ...
        async finalizeDatabase(databasePath, threadsFlag, memoryFlag) {
            ...
            try {
                ...
                if (e instanceof CommandInvocationError &&
                    ...
                    (0, cli_config_errors_1.isCliConfigurationError)(cli_config_errors_1.CliError.NoJavaScriptTypeScriptCodeFound, e.stderr, e.exitCode)) {
                    throw new util.ConfigurationError((0, cli_config_errors_1.processCliConfigurationError)(cli_config_errors_1.CliError.NoJavaScriptTypeScriptCodeFound, e.stderr));
                }
                throw e;
            }
        },
