...
async function generateCodeScanningConfig(config, logger) {
    ...
    if (config.augmentationProperties.queriesInput ||
        ...
        if (config.augmentationProperties.queriesInputCombines) {
            augmentedConfig.queries = (augmentedConfig.queries || []).concat(config.augmentationProperties.queriesInput || [], config.augmentationProperties.qualityQueriesInput || []);
        }
        else {
            augmentedConfig.queries = (config.augmentationProperties.queriesInput || []).concat(config.augmentationProperties.qualityQueriesInput || []);
        }
    }
