 ...
 */
async function getDefaultConfig(tempDir, toolCacheDir) {
 ...
 */
async function loadConfig(configFile, tempDir, toolCacheDir) {
    let parsedYAML;
 ...
 */
async function initConfig(tempDir, toolCacheDir) {
