 ...
 */
async function parseBuiltinSuite(configFile, languages, resultMap, suiteName) {
 ...
 */
async function parseLocalQueryPath(configFile, resultMap, localQueryPath) {
 ...
 */
async function parseRemoteQuery(configFile, resultMap, queryUses) {
...
exports.getBlankConfig = getBlankConfig;
/**
 ...
 */
function getParsedConfigFolder() {
