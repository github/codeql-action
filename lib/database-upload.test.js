...
(0, ava_1.default)("Abort database upload if feature flag is disabled", async (t) => {
    await (0, util_1.withTmpDir)(async (tmpDir) => {
        ...
        const loggedMessages = [];
        await (0, database_upload_1.uploadDatabases)(testRepoName, getTestConfig(tmpDir), (0, feature_flags_1.createFeatureFlags)(["uploads_domain_enabled"]), testApiDetails, (0, testing_utils_1.getRecordingLogger)(loggedMessages));
        t.assert(loggedMessages.find((v) => v.type === "debug" &&
            v.message ===
...
(0, ava_1.default)("Don't crash if uploading a database fails", async (t) => {
    await (0, util_1.withTmpDir)(async (tmpDir) => {
        ...
        sinon
            ...
            .returns("true");
        sinon.stub(actionsUtil, "isAnalyzingDefaultBranch").resolves(true);
        const featureFlags = (0, feature_flags_1.createFeatureFlags)(["database_uploads_enabled"]);
