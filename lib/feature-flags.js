...
class Features {
    ...
    async getValue(feature, codeql) {
        ...
        if (feature === Feature.AnalysisSummaryV2Enabled) {
            return util.codeQlVersionAbove(codeql, exports.CODEQL_VERSION_ANALYSIS_SUMMARY_V2);
        }
        if (feature === Feature.LanguageBaselineConfigEnabled) {
            return util.codeQlVersionAbove(codeql, exports.CODEQL_VERSION_LANGUAGE_BASELINE_CONFIG);
        }
