...
exports.getGitRoot = exports.getAllFileOids = exports.decodeGitFilePath = exports.getGitDiffHunkHeaders = exports.getAllGitMergeBases = exports.gitRepack = exports.gitFetch = exports.deepenGitHistory = exports.determineBaseBranchHeadCommitOid = exports.getCommitOid = void 0;
 ...
 */
const getAllFileOids = async function (checkoutPath) {
    const stdout = await runGitCommand(checkoutPath, ["ls-tree", "--format=%(objectname)_%(path)", "-r", "HEAD"], "Cannot list file OIDs in HEAD.");
    const fileOidMap = {};
...
exports.getAllFileOids = getAllFileOids;
/**
 ...
 */
const getGitRoot = async function (checkoutPath) {
    try {
        const stdout = await runGitCommand(checkoutPath, ["rev-parse", "--show-toplevel"], "Cannot determine the root of the Git repository.");
        return stdout.trim();
    }
    catch (error) {
