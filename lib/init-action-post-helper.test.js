...
(0, ava_1.default)("uploads failed SARIF run for workflow with upload: always", async (t) => {
    const actionsWorkflow = createTestWorkflow([
        {
            name: "Checkout repository",
            uses: "actions/checkout@v3",
...
(0, ava_1.default)("uploads failed SARIF run for workflow with upload: failure-only", async (t) => {
    const actionsWorkflow = createTestWorkflow([
        {
            name: "Checkout repository",
            uses: "actions/checkout@v3",
...
(0, ava_1.default)("uploads failed SARIF run for workflow with upload: true", async (t) => {
    const actionsWorkflow = createTestWorkflow([
        {
            name: "Checkout repository",
            uses: "actions/checkout@v3",
...
(0, ava_1.default)("uploads failed SARIF run for workflow with upload: false", async (t) => {
    const actionsWorkflow = createTestWorkflow([
        {
            name: "Checkout repository",
            uses: "actions/checkout@v3",
...
(0, ava_1.default)("uploads failed SARIF run for workflow with unrecognized upload input", async (t) => {
    const actionsWorkflow = createTestWorkflow([
        {
            name: "Checkout repository",
            uses: "actions/checkout@v3",
...
(0, ava_1.default)("uploading failed SARIF run skipped for workflow with upload: never", async (t) => {
    const actionsWorkflow = createTestWorkflow([
        {
            name: "Checkout repository",
            uses: "actions/checkout@v3",
