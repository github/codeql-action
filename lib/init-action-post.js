...
async function runWrapper() {
    ...
    try {
        ...
        await (0, status_report_1.sendStatusReport)(await (0, status_report_1.createStatusReportBase)("init-post", (0, status_report_1.getActionsStatus)(error), startedAt, config, await (0, util_1.checkDiskUsage)(), error.message, error.stack));
        return;
    }
    const statusReportBase = await (0, status_report_1.createStatusReportBase)("init-post", "success", startedAt, config, await (0, util_1.checkDiskUsage)());
    const statusReport = {
        ...statusReportBase,
