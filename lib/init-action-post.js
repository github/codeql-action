...
async function runWrapper() {
    ...
    const statusReport = {
        ...
        job_status: process.env[environment_1.EnvVar.JOB_STATUS] ?? status_report_1.JobStatus.Unknown,
    };
    core.info(`Sending job_status field as ${process.env[environment_1.EnvVar.JOB_STATUS] ?? status_report_1.JobStatus.Unknown}`);
