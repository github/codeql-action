...
async function initConfig(languagesInput, queriesInput, configFile, externalRepositoryToken, repository, tempDir, toolCacheDir, codeQL, checkoutPath, githubAuth, githubUrl, logger) {
    ...
    const config = await configUtils.initConfig(languagesInput, queriesInput, configFile, externalRepositoryToken, repository, tempDir, toolCacheDir, codeQL, checkoutPath, githubAuth, githubUrl, logger);
