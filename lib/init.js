...
function processError(e) {
    ...
    if ((0, cli_config_errors_1.isConfigurationError)(cli_config_errors_1.CliError.InitCalledTwice, e.message)) {
        return new util.UserError(`Is the "init" action called twice in the same job? ${e.message}`);
    }
    if ((0, cli_config_errors_1.isConfigurationError)(cli_config_errors_1.CliError.IncompatibleWithActionVersion, e.message) ||
        (0, cli_config_errors_1.isConfigurationError)(cli_config_errors_1.CliError.InvalidSourceRoot, e.message)) {
