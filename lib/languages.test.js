...
(0, ava_1.default)("isTracedLanguage", async (t) => {
    ...
    t.true((0, languages_1.isTracedLanguage)(languages_1.Language.go, logger));
    t.true((0, languages_1.isTracedLanguage)(languages_1.Language.java, logger));
    t.true((0, languages_1.isTracedLanguage)(languages_1.Language.swift, logger));
    ...
    t.false((0, languages_1.isTracedLanguage)(languages_1.Language.ruby, logger));
});
(0, ava_1.default)("isScannedLanguage", async (t) => {
    ...
    t.false((0, languages_1.isScannedLanguage)(languages_1.Language.go, logger));
    t.false((0, languages_1.isScannedLanguage)(languages_1.Language.java, logger));
    t.false((0, languages_1.isScannedLanguage)(languages_1.Language.swift, logger));
    ...
    t.true((0, languages_1.isScannedLanguage)(languages_1.Language.ruby, logger));
});
