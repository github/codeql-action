...
async function run() {
    ...
    try {
        if (!(await (0, api_client_1.sendStatusReport)(await (0, actions_util_1.createStatusReportBase)(ACTION_NAME, "starting", startedAt)))) {
            return;
        }
        ...
        if (error instanceof codeql_1.CommandInvocationError) {
            ...
            await (0, api_client_1.sendStatusReport)(await (0, actions_util_1.createStatusReportBase)(ACTION_NAME, (0, actions_util_1.getActionsStatus)(error), startedAt, error.message, error.stack));
        }
        return;
    }
    await (0, api_client_1.sendStatusReport)(await (0, actions_util_1.createStatusReportBase)(ACTION_NAME, "success", startedAt));
}
