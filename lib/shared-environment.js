...
exports.ODASA_TRACER_CONFIGURATION = exports.CODEQL_WORKFLOW_STARTED_AT = exports.CODEQL_ACTION_TEST_MODE = exports.CODEQL_ACTION_TESTING_ENVIRONMENT = exports.CODEQL_ACTION_ANALYZE_DID_COMPLETE_SUCCESSFULLY = exports.CODEQL_ACTION_DID_AUTOBUILD_GOLANG = exports.CODEQL_ACTION_IS_DATABASE_CLUSTER = void 0;
/**
 * Environment variable that is set to true when `codeql database init --db-cluster" is run.
 */
exports.CODEQL_ACTION_IS_DATABASE_CLUSTER = "CODEQL_ACTION_IS_DATABASE_CLUSTER";
/**
