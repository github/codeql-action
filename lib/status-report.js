...
(function (JobStatus) {
    ...
    JobStatus["ConfigError"] = "JOB_STATUS_CONFIGURATION_ERROR";
...
function setJobStatusIfUnsuccessful(actionStatus) {
    if (actionStatus === "user-error") {
        core.exportVariable(environment_1.EnvVar.JOB_STATUS, process.env[environment_1.EnvVar.JOB_STATUS] ?? JobStatus.ConfigError);
    }
