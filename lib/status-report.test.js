...
(0, ava_1.default)("getActionStatus handling correctly various types of errors", (t) => {
    ...
    t.is((0, status_report_1.getActionsStatus)(isFirstPartyAnalysis, new Error("arbitrary error")), "failure", "We categorise an arbitrary error as a failure");
    t.is((0, status_report_1.getActionsStatus)(isFirstPartyAnalysis, new util_1.ConfigurationError("arbitrary error")), "user-error", "We categorise a ConfigurationError as a user error");
    t.is((0, status_report_1.getActionsStatus)(isFirstPartyAnalysis, new Error("exit code 1"), "multiple things went wrong"), "failure", "getActionsStatus should return failure if passed an arbitrary error and an additional failure cause");
    t.is((0, status_report_1.getActionsStatus)(isFirstPartyAnalysis, new util_1.ConfigurationError("exit code 1"), "multiple things went wrong"), "user-error", "getActionsStatus should return user-error if passed a configuration error and an additional failure cause");
    t.is((0, status_report_1.getActionsStatus)(isFirstPartyAnalysis), "success", "getActionsStatus should return success if no error is passed");
    t.is((0, status_report_1.getActionsStatus)(isFirstPartyAnalysis, new Object()), "failure", "getActionsStatus should return failure if passed an arbitrary object");
    t.is((0, status_report_1.getActionsStatus)(isFirstPartyAnalysis, null, "an error occurred"), "failure", "getActionsStatus should return failure if passed null and an additional failure cause");
    t.is((0, status_report_1.getActionsStatus)(isFirstPartyAnalysis, (0, util_1.wrapError)(new util_1.ConfigurationError("arbitrary error"))), "user-error", "We still recognise a wrapped ConfigurationError as a user error");
    t.is((0, status_report_1.getActionsStatus)(isThirdPartyAnalysis, new upload_lib_1.InvalidSarifUploadError("SyntaxError: Unexpected end of JSON input")), "user-error", "We recognise an InvalidSarifUploadError as a user error if the tool that generated the SARIF file is not ours");
    t.is((0, status_report_1.getActionsStatus)(isFirstPartyAnalysis, new upload_lib_1.InvalidSarifUploadError("arbitrary error")), "failure", "We recognise an InvalidSarifUploadError as a failure if the tool that generated the SARIF file is ours");
});
