...
async function downloadAndExtract(codeqlURL, dest, authorization, headers, tarVersion, logger) {
    ...
    try {
        ...
        core.warning(`Failed to download and extract CodeQL bundle using streaming. Falling back to downloading the bundle before extracting.`);
        core.warning(`Error: ${(0, util_1.getErrorMessage)(e)}`);
