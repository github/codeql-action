...
exports.setTracerEnvVariables = setTracerEnvVariables;
 ...
 */
function setTracerEnvVariables(logger) {
    logger.info("Setting build tracing environment variables. Subsequent steps of this job will be traced unless otherwise specified.");
    const tracerConfigEnv = JSON.parse(process.env["CODEQL_ACTION_TRACER_CONFIG_ENV"] ?? "null");
