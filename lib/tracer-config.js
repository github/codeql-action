...
exports.unsetTracerEnvVarForCurrentProcess = unsetTracerEnvVarForCurrentProcess;
 ...
 */
function unsetTracerEnvVarForCurrentProcess() {
    delete process.env[environment_1.EnvVar.DYLD_INSERT_BINARIES];
}
