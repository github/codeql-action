...
(0, ava_1.default)("validate correct payload used for push, PR merge commit, and PR head", async (t) => {
    ...
    const pushPayload = uploadLib.buildPayload("commit", "refs/heads/master", "key", undefined, "", undefined, undefined, "/opt/src", undefined, ["CodeQL", "eslint"], "mergeBaseCommit");
    ...
    const prMergePayload = uploadLib.buildPayload("commit", "refs/pull/123/merge", "key", undefined, "", undefined, undefined, "/opt/src", undefined, ["CodeQL", "eslint"], "mergeBaseCommit");
    ...
    const prHeadPayload = uploadLib.buildPayload("headCommit", "refs/pull/123/head", "key", undefined, "", undefined, undefined, "/opt/src", undefined, ["CodeQL", "eslint"], "mergeBaseCommit");
