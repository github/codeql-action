...
(0, ava_1.default)("validateResultsLimit when empty", (t) => {
    t.notThrows(() => uploadLib.validateResultsLimit(createMockSarif()));
});
(0, ava_1.default)("validateResultsLimit with <= 5000 results should pass", (t) => {
    const sarif1 = createMockSarif("abc", "def");
    const sarif2 = createMockSarif("ghi", "jkl");
...
(0, ava_1.default)("validateResultsLimit with > 5000 results should fail", (t) => {
    const sarif1 = createMockSarif("abc", "def");
    const sarif2 = createMockSarif("ghi", "jkl");
