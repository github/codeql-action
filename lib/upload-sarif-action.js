...
async function sendSuccessStatusReport(startedAt, uploadStats, logger) {
    const statusReportBase = await (0, status_report_1.createStatusReportBase)(ACTION_NAME, "success", startedAt, undefined, await (0, util_1.checkDiskUsage)(), logger);
    const statusReport = {
        ...statusReportBase,
        ...uploadStats,
    };
...
async function run() {
    ...
    try {
        ...
        const error = !(0, actions_util_1.isFirstPartyAnalysis)(ACTION_NAME) &&
        ...
        console.log(error);
        await (0, status_report_1.sendStatusReport)(await (0, status_report_1.createStatusReportBase)(ACTION_NAME, (0, status_report_1.getActionsStatus)(error), startedAt, undefined, await (0, util_1.checkDiskUsage)(), logger, message, error.stack));
        return;
    }
}
