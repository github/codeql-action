...
function getWorkflowRunAttempt() {
    const workflowRunAttempt = parseInt((0, util_1.getRequiredEnvParam)("GITHUB_RUN_ATTEMPT"), 10);
    if (Number.isNaN(workflowRunAttempt)) {
        throw new Error("GITHUB_RUN_ATTEMPT must define a non NaN workflow run attempt");
    }
