...
export type NamedCreateRuleMeta<MessageIds extends string> = Omit<RuleMetaData<MessageIds>, 'docs'> & {
 ...
 */
export declare function RuleCreator(urlCreator: (ruleName: string) => string): <Options extends readonly unknown[], MessageIds extends string>({ name, meta, ...rule }: Readonly<RuleWithMetaAndName<Options, MessageIds>>) => RuleModule<MessageIds, Options, RuleListener>;
