...
export interface SuggestionReportDescriptor<TMessageIds extends string> extends Omit<ReportDescriptorBase<TMessageIds>, 'fix'> {
...
export type ReportSuggestionArray<TMessageIds extends string> = SuggestionReportDescriptor<TMessageIds>[];
...
export interface RuleModule<TMessageIds extends string, TOptions extends readonly unknown[] = [], TRuleListener extends RuleListener = RuleListener> {
    /**
...
export type RuleCreateFunction<TMessageIds extends string = never, TOptions extends readonly unknown[] = unknown[]> = (context: Readonly<RuleContext<TMessageIds, TOptions>>) => RuleListener;
