...
import { getTrapCachingExtractorConfigArgs, getTrapCachingExtractorConfigArgsForLang } from "./trap-caching";
  ...
  const codeql = {
    ...
    async databaseInitCluster(
      ...
      await runTool(cmd, [
        ...
        config.dbLocation,
        `--source-root=${sourceRoot}`,
        ...await getTrapCachingExtractorConfigArgs(config),
        ...extraArgs,
        ...getExtraOptionsFromEnv(["database", "init"]),
      ]);
    },
